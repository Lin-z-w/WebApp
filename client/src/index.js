...
$(document).ready(function () {
        ...
        $.get(json_api + 'product', function (data) {
            ...
            data.forEach(item => {
                ...
                let item_info = `<div class="col-lg-2 box ${item.category}"
                      ...
                      <div id="image"><img src="${item.img}" id="product_img" alt=""></div>                    
  ...
  ${settings.img == "" ? settings.img : '<img style="max-width: 50px;max-width: 100px;" src ="' + json_img + settings.img + '" /><br>'}
  ...
  <table width="100%">
      ...
      <p style="text-align: center;">
       ${settings.footer}
        ...
        //         dataType: "json",
        //         data: JSON.stringify({ quantity: cart[i].quantity }), // 修改为购买数量
        //         type: "PATCH",
        //         success: function (data) {
        //             console.log("Data updated!");
        //         },
