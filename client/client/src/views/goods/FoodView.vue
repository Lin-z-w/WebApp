        ...
        <el-container style="height: 750px; border: 1px solid #eee">
            ...
            <el-container>
                ...
                <el-container>
                    ...
                    <el-footer style="background-color: #f2f2f2; text-align: right;">
                        <span style="line-height: 60px; font-size: 30px; font-weight: 1000">当前已选择商品总价：</span>
                        <span style="line-height: 60px; font-size: 30px; font-weight: 1000; color: red">{{ $store.state.totalPrice }}</span>
                    </el-footer>
                </el-container>
            </el-container>
        </el-container>
